...
from third_party.aspanformer.src.ASpanFormer.aspanformer import (
    ASpanFormer as ASpanFormer_,
)
...
class ASpanFormer(Matching):
    ...
    def match_inputs_(self, gray1, gray2, mask1=None, mask2=None):
        ...
        if mask1 is not None and mask2 is not None and self.coarse_scale:
            ...
            batch.update(
                {"mask0": ts_mask_1.unsqueeze(0), "mask1": ts_mask_2.unsqueeze(0)}
            )
    ...
    def match_pairs(self, im1_path, im2_path):
        ...
        matches, kpts1, kpts2, scores = self.match_inputs_(gray1, gray2, mask1, mask2)
